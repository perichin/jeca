...
<div id="welcome-panel" class="welcome-panel thr-welcome-panel">
	<a href="#" class="welcome-panel-close" id="thr_welcome_box_hide">Dismiss</a>
	<div class="welcome-panel-content">
		...
		<div class="welcome-panel-column-container">
			...
			<div class="welcome-panel-column">
				...
				<a class="button button-primary button-hero" href="<?php echo esc_url(admin_url('admin.php?page=thr_options&tab=19')); ?>">Import demo</a>
			...
			<div class="welcome-panel-column welcome-panel-last">
				...
				<a class="button button-primary button-hero" href="http://demo.mekshq.com/throne/documentation" target="_blank">Learn more</a> <span class="thr-customize-welcome">or <a href="<?php echo esc_url(admin_url('admin.php?page=thr_options')); ?>">start customizing</a> now</span>.
			</div>
