...
<div id="welcome-panel" class="welcome-panel thr-welcome-panel">
	<a href="#" class="welcome-panel-close" id="thr_update_box_hide">Dismiss</a>
	<div class="welcome-panel-content">

		<h2>Congratulations, your website just got better!</h2>
		<p class="about-description"><?php echo THEME_NAME;?> has been successfully updated to version <?php echo THEME_VERSION; ?></a></p>
		...
		<div class="welcome-panel-column-container">
				...
				<a href="http://demo.mekshq.com/throne/documentation/#changelog" target="_blank" class="button button-primary button-hero">View change log</a>
				</div>

				<div class="welcome-panel-column">
				<h3>We listen to your feedback</h3>
				<p>If you have ideas which might help us make Throne even better, we would love to hear from you!</p>
				<a href="http://mekshq.com/contact" target="_blank" class="button button-primary button-hero">Get in touch</a>
				</div>

				<?php 
				$tweet_text = "I'm very happy using Throne! Check out this great #WordPress theme by @meksHQ";
				$tweet_url = "http://mekshq.com/demo/throne";
				?>

				<div class="welcome-panel-column">
				<h3>Happy with <?php echo THEME_NAME;?>?</h3>
