...
class THR_Adsense_Widget extends WP_Widget { 
	...
	function __construct() {
		...
		parent::__construct( 'thr_adsense_widget', __('Throne Adsense', THEME_SLUG), $widget_ops, $control_ops );
	...
	function widget( $args, $instance ) {
		...
		if($instance['expand']){
			$before_widget = preg_replace('/class="(.*)"/', 'class="$1 thr_adsense_expand"', $before_widget);
		}
