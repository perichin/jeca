...
class THR_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'thr_posts_widget', __('Throne Posts', THEME_SLUG), $widget_ops, $control_ops );
			...
			<?php	while($thr_posts->have_posts()) : $thr_posts->the_post(); ?>
		 		...
		 		<li>
	 				...
	 				<?php if(!empty($instance['meta']) && $meta = thr_get_meta_data('',$instance['meta'])): ?>
		 				<span class="entry-meta"><?php echo $meta;?></span>
		 			<?php endif; ?>
		 			<a href="<?php echo esc_url(get_permalink()); ?>" class="featured_posts_link"><?php echo $p_title; ?></a>
		 			</span>
		 			</span>
	...
	function form( $instance ) {
		...
		<p>
		   	 <label for="<?php echo $this->get_field_id( 'title_more' ); ?>"><?php _e('Posts titles more string', THEME_SLUG); ?>:</label>
			 <input id="<?php echo $this->get_field_id( 'title_more' ); ?>" type="text" name="<?php echo $this->get_field_name( 'title_more' ); ?>" value="<?php echo esc_attr($instance['title_more']); ?>" class="small-text" />
		</p>
